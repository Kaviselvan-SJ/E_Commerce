  ...
  return (
    ...
    <div className="min-h-screen py-16 px-4 md:px-16 ">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8 text-red-700 dark:text-red-300">
          About Pon Traders
        </h1>

        <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
          Welcome to <span className="font-semibold text-red-600 dark:text-red-400">Pon Traders</span>, the official distributor of <span className="font-bold text-red-700 dark:text-red-300">IPOL</span> brand lubricants and battery products in your region.
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-bold text-red-700 dark:text-red-400 text-center mb-6">
            What Our Clients Say
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            {/* Testimonial 1 */}
            <div className="bg-white dark:bg-neutral-800 shadow-md rounded-xl p-6">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="font-semibold text-gray-800 dark:text-gray-100">Arun M.</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Owner, RM Auto Care</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-800 shadow-md rounded-xl p-6">
              <p className="text-gray-700 dark:text-gray-300 italic mb-4">
                “Their commitment to distributing only genuine IPOL oils and batteries makes them stand out. Their service is top-notch.”
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-red-300 dark:bg-red-700 text-white flex items-center justify-center font-bold">
                  S
                ...
                <div className="ml-4">
                  <p className="font-semibold text-gray-800 dark:text-gray-100">Sujatha R.</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Manager, Speed Lube Center</p>
                </div>
              </div>
            </div>
          </div>
