      ...
      <div className={`min-h-screen flex flex-col pt-20 `}>
        <div className="flex-1 flex justify-center px-4 py-12">
          <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div
              className={`rounded-2xl shadow-xl p-8 bg-slate-800 text-white`}
            >
            ...
            <div className="rounded-2xl shadow-xl p-8 flex flex-col justify-between bg-slate-800 text-white">
              <div>
